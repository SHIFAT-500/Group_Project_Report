...
{
    public partial class createcertificate1 : Form
    {
        public createcertificate1()
        {
            InitializeComponent();
        }
        ...
        private void searchtextbox_TextChanged(object sender, EventArgs e)
        {
            if (searchtextbox.Text != "")
            {
                ...
                cmd.CommandText = "select * from addstudentcourse1 where senroll LIKE '" + searchtextbox.Text + "%'";
            ...
            else
            {
                ...
                cmd.CommandText = "select * from addstudentcourse1";
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataSet ds = new DataSet();
                da.Fill(ds);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "select * from addstudentcourse1 where stuorder = " + bid + "";
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataSet ds = new DataSet();
                da.Fill(ds);
        ...
        private void createbutton_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from createcertificate1 where senroll = '" + enrolltextbox.Text + "'";
            ...
            else
            {
                ...
                con1.ConnectionString = "data source = (localdb)\\Local; database = certificate_generator2; integrated security = True";
                SqlCommand cmd1 = new SqlCommand();
                cmd1.Connection = con1;

                con1.Open();
                cmd1.CommandText = " insert into createcertificate1(sname,senroll,sgender,scontact,semail,sinstitute,scountry,Issue_date) values ('" + sname + "','" + senroll + "','" + sgender + "','" + scontact + "','" + semail + "','" + sinstitute + "','" + scountry + "','" + date + "')";
        ...
        private void printbutton_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from createcertificate1 where senroll = '" + searchtextbox2.Text + "'";
        ...
        private void printdocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            Bitmap bitmap = Properties.Resources.seminer1;
            Image image = new Bitmap(bitmap);
            e.Graphics.DrawImage(image, 0, 0, 1100, 850);

            e.Graphics.DrawString(sname, new Font("Arial Black", 16, FontStyle.Regular), Brushes.Black, new Point(460, 318));
            e.Graphics.DrawString(senroll, new Font("Arial Black", 16, FontStyle.Regular), Brushes.Black, new Point(410, 367));
            e.Graphics.DrawString(scountry, new Font("Arial Black", 16, FontStyle.Regular), Brushes.Black, new Point(700, 367));
            e.Graphics.DrawString(sinstitute, new Font("Cambria", 16, FontStyle.Regular), Brushes.Black, new Point(390, 412));
            e.Graphics.DrawString(datetime.Text, new Font("Cambria", 12, FontStyle.Regular), Brushes.Black, new Point(860, 145));
        }
