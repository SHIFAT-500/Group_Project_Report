...
{
    public partial class createcertificate2 : Form
    {
        ...
        private void createbutton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                con1.Open();
                cmd1.CommandText = " insert into createcertificate2(sname,senroll,sgender,scontact,semail,sinstitute,scountry,Issue_date) values ('" + sname + "','" + senroll + "','" + sgender + "','" + scontact + "','" + semail + "','" + sinstitute + "','" + scountry + "','" + date + "')";
        ...
        private void printbutton_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from createcertificate2 where senroll = '" + searchtextbox2.Text + "'";
