...
namespace Certificate_Generator
{
    public partial class profile1 : Form
    {
        ...
        private void refershbutton_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from addstudentcourse1 where semail = '" + semail + "'";
            ...
            cmd1.CommandText = "select * from createcertificate1 where semail = '" + semail + "'";
        ...
        private void printdocument1_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            cmd.CommandText = "select * from createcertificate1 where semail = '" + semail + "'";
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
            da.Fill(ds);
            ...
            e.Graphics.DrawString(date, new Font("Cambria", 12, FontStyle.Regular), Brushes.Black, new Point(860, 145));
        }
