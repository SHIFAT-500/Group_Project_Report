...
{
    public partial class listcertificate1 : Form
    {
        public listcertificate1()
        {
            InitializeComponent();
        }
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            if (searchtextbox.Text != "")
            {
                ...
                cmd.CommandText = "select * from createcertificate1 where senroll LIKE '" + searchtextbox.Text + "%'";
            ...
            else
            {
                ...
                cmd.CommandText = "select * from createcertificate1";
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataSet ds = new DataSet();
                da.Fill(ds);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "select * from createcertificate1 where stuorder = " + bid + "";
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataSet ds = new DataSet();
                da.Fill(ds);
        ...
        private void updatebutton_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Data will be upated. Confirm?", "Success", MessageBoxButtons.OKCancel, MessageBoxIcon.Information) == DialogResult.OK)
            {
                ...
                cmd.CommandText = "update createcertificate1 set sname = '" + sname + "',senroll = '" + senroll + "',sinstitute = '" + sinstitute + "',scountry = '" + scountry + "',Issue_date = '" + date + "' where stuorder = " + rowid + "";
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataSet ds = new DataSet();
                da.Fill(ds);
        ...
        private void deletebutton_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Data will be Deleted. Confirm?", "Delete", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning) == DialogResult.OK)
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = con;
                cmd.CommandText = "delete from createcertificate1 where stuorder = " + rowid + "";
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataSet ds = new DataSet();
                da.Fill(ds);
