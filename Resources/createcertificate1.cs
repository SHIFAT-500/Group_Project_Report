...
namespace Certificate_Generator
{
    public partial class createcertificate1 : Form
    {
        ...
        private void printdocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            String sgender = ds.Tables[0].Rows[0][3].ToString();
            String scontact = ds.Tables[0].Rows[0][4].ToString();
            String semail = ds.Tables[0].Rows[0][5].ToString();
            String sinstitute = ds.Tables[0].Rows[0][6].ToString();
            String scountry = ds.Tables[0].Rows[0][7].ToString();

            Bitmap bitmap = Properties.Resources.certificate_course1_page_0001;
            Image image = new Bitmap(bitmap);
            e.Graphics.DrawImage(image, 0, 0, 850, 1100);
            e.Graphics.DrawString(sname, new Font("Algerian", 16, FontStyle.Regular), Brushes.Black, new Point(150, 318));
            e.Graphics.DrawString(senroll, new Font("Algerian", 16, FontStyle.Regular), Brushes.Black, new Point(100, 367));
            e.Graphics.DrawString(sinstitute, new Font("Algerian", 16, FontStyle.Regular), Brushes.Black, new Point(145, 415));
            e.Graphics.DrawString(scountry, new Font("Algerian", 16, FontStyle.Regular), Brushes.Black, new Point(157, 465));
        }
