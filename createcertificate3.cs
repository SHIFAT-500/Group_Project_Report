...
{
    public partial class createcertificate3 : Form
    {
        public createcertificate3()
        {
            InitializeComponent();
        }
        ...
        private void createbutton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                con1.Open();
                cmd1.CommandText = " insert into createcertificate3(sname,senroll,sgender,scontact,semail,sinstitute,scountry,Issue_date) values ('" + sname + "','" + senroll + "','" + sgender + "','" + scontact + "','" + semail + "','" + sinstitute + "','" + scountry + "','" + date + "')";
        ...
        private void printbutton_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from createcertificate3 where senroll = '" + searchtextbox2.Text + "'";
        ...
        private void printdocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString(datetime.Text, new Font("Cambria", 12, FontStyle.Regular), Brushes.Black, new Point(123, 225));
        }
