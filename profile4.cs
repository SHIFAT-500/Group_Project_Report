...
{
    public partial class profile4 : Form
    {
        public profile4()
        {
            InitializeComponent();
        ...
        private void refershbutton_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from addstudentcourse4 where semail = '" + semail + "'";
            ...
            cmd1.CommandText = "select * from createcertificate4 where semail = '" + semail + "'";
        ...
        private void printdocument1_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            cmd.CommandText = "select * from createcertificate4 where semail = '" + semail + "'";
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
            da.Fill(ds);
